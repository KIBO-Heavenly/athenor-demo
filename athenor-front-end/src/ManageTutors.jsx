...
import { MOCK_OA_DATA, MOCK_TUTOR_COLORS } from './mockData';
...
export default function ManageTutors() {
  ...
  // Save a custom color for a tutor (demo mode - localStorage only)
  const saveTutorColor = (tutorName, colorIndex) => {
    ...
    setModalMessage("Color updated successfully (demo mode)!");
  ...
  const handleEditSave = () => {
    ...
    setModalTitle("Success");
    setModalMessage("Office Assistant updated (demo mode)!");
    setModalType("success");
    setModalOpen(true);
  ...
  const handleDeleteTutor = (index) => {
    ...
    // Demo mode - just update local state
    setModalTitle("Success");
    setModalMessage("Office Assistant deleted (demo mode)!");
    setModalType("success");
    setModalOpen(true);
  };
