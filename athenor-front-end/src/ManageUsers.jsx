...
import { MOCK_USERS, MOCK_USER_STATS } from './mockData';
...
export default function ManageUsers() {
  ...
  const handleDeleteUser = () => {
    ...
    setTimeout(() => {
      ...
      // Remove user from local state (demo simulation)
      ...
      setModalMessage("User deleted successfully (demo simulation).");
