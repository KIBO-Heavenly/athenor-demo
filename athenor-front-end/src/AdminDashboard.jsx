...
import { MOCK_IMPORTED_DATA } from './mockData';
...
export default function AdminDashboard() {
  ...
  const handleTitleSubmit = async () => {
    ...
    // Navigate to the ImportedData page with mock data
    navigate('/imported-data', {
      state: {
        headers: MOCK_IMPORTED_DATA.headers,
        data: MOCK_IMPORTED_DATA.data,
        totalRows: MOCK_IMPORTED_DATA.totalRows,
        title: dataTitle
      }
    });
          ...
          <div className="max-w-7xl mx-auto px-6 py-28 text-center">
            ...
            >
              <motion.button 
                ...
                {uploading ? 'Loading Demo Data...' : 'Import Data'}
              </motion.button>
