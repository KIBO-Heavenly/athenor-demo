...
import { getReviewsForTutor } from './mockData';
...
export default function SeeReviews() {
  ...
  const loadMockReviews = (userId) => {
    // Simulate loading delay
    setTimeout(() => {
      const data = getReviewsForTutor(userId);
  ...
  const handleRefresh = () => {
    ...
    setRefreshing(true);
    setTimeout(() => {
      loadMockReviews(currentUser.id);
      setRefreshing(false);
    }, 500);
  };
